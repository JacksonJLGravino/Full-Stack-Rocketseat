// Sleciona os elementos do formulário
...
function updateTotals() {
  try {
    ...
    // Percorre cada utem da lista
    for (let item = 0; item < items.length; item++) {
      const itemAmount = items[item].querySelector(".expense-amount");

      // Remove caracteres não numéricos e substitui a vírcula pelo ponto
